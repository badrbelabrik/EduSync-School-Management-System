...
<aside class="w-72 bg-gradient-to-b from-blue-900 via-blue-900 to-indigo-950 text-white p-6 min-h-screen shadow-2xl flex flex-col">
    ...
    <nav class="space-y-2 flex-1">
        ...
        <a href="../public/dashboard-prof.php?page=courses"
            ...
            <span class="font-medium">MY COURSES
            </span>
        </a>

        <a href="../public/dashboard-prof.php?page=students_of_myclasses"
            ...
            <span class="font-medium">STUDENTS OF MY CLASSES
            </span>
        </a>

        <a href="../public/dashboard-prof.php?page=students_of_mycoursses"
